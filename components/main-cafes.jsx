...
export default function MainCafes() {
  return (
    <section className="mb-16">
      <div className="lg:max-w-[75rem] md:max-w-[45rem] max-w-[27rem] mx-auto bg-[#1B1D1F] -mt-[10rem] px-5 lg:px-14 lg:py-16 md:px-10 md:py-12 py-10 rounded-2xl relative overflow-hidden">
        <Image
          src="/vector.svg"
          alt="vector"
          width={250}
